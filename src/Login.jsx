                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-md-4 mt-5 p-4 text-center bg-white shadow">
                            ...
                            <select className="form-control">
                                <option selected>Business Size</option>
                                <option>Business Size 1</option>
                                <option>Business Size 2</option>
                                <option>Business Size 3</option>
                                <option>Business Size 4</option>
                            </select><br />
